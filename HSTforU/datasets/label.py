...
class Label:
    def __init__(self, config):
        ...
        if dataset_name == 'shanghaitech':
            ...
            self.frame_mask = os.path.join(root, dataset_name, f'annotation/{scene}/*')
        elif dataset_name in ['drone/railway', 'drone/highway', 'drone/crossroads', 'drone/bike', 'drone/vehicle',
                              'drone/solar', 'drone/farmland']:
            self.frame_mask = os.path.join(root, dataset_name, f'annotation/*')
        mat_name = dataset_name + '.mat'

        self.mat_path = os.path.join(root, dataset_name, mat_name)

        train_or_test = "testing"
        test_dataset_path = os.path.join(root, dataset_name, train_or_test, "frames")
    ...
    def __call__(self):
        if self.dataset_name == 'shanghaitech' or self.dataset_name == 'drone' or \
                self.dataset_name in ['drone/railway', 'drone/highway', 'drone/crossroads', 'drone/bike',
