...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False, pretrained=None, logger=None):
        super().__init__()
        ...
        self.apply(self._init_weights)
        self.init_weights(logger=logger, pretrained=pretrained)
...
class pvt_v2_b1(PyramidVisionTransformerV2):
    def __init__(self, **kwargs):
        super(pvt_v2_b1, self).__init__(
            ...
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'], logger=kwargs['logger'])
